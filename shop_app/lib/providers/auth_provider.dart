...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticateUser(
      String email, String password, String urlOption) async {
    final url =
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlOption?key=AIzaSyBlj-MN5_avFe9YT9rizUs7Y6qDPmocdtQ";
    try {
  ...
  Future<bool> tryAutoLoginMethod() async {
      final prefs = await SharedPreferences.getInstance();
